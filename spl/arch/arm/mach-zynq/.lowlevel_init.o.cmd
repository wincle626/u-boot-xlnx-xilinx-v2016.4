cmd_spl/arch/arm/mach-zynq/lowlevel_init.o := arm-linux-gnueabi-gcc -Wp,-MD,spl/arch/arm/mach-zynq/.lowlevel_init.o.d  -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabi/5/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -D__ASSEMBLY__ -g -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -I./arch/arm/mach-zynq/include -mfpu=neon   -c -o spl/arch/arm/mach-zynq/lowlevel_init.o arch/arm/mach-zynq/lowlevel_init.S

source_spl/arch/arm/mach-zynq/lowlevel_init.o := arch/arm/mach-zynq/lowlevel_init.S

deps_spl/arch/arm/mach-zynq/lowlevel_init.o := \
...
spl/arch/arm/mach-zynq/lowlevel_init.o: $(deps_spl/arch/arm/mach-zynq/lowlevel_init.o)
